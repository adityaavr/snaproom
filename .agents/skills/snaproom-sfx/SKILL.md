...
allowed-tools: Read Write Glob Bash(ls *) Bash(node .Codex/scripts/project/project-state.mjs *) Bash(node .Codex/scripts/project/ensure-local-assets.mjs *) Bash(node .Codex/scripts/sfx/fal-elevenlabs-sfx.mjs *)
context: fork
agent: snaproom-sfx
---
...
```bash
node .Codex/scripts/sfx/fal-elevenlabs-sfx.mjs \
  --prompt "<sound prompt>" \

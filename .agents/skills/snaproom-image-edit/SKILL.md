...
allowed-tools: Read Write Glob Bash(ls *) Bash(node .Codex/scripts/project/ensure-local-assets.mjs *) Bash(node .Codex/scripts/image-edit/generate-edit.mjs *)
context: fork
agent: snaproom-image-edit
---

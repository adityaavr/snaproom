...
allowed-tools: Read Write Glob Bash(ls *) Bash(node .Codex/scripts/project/project-state.mjs *) Bash(node .Codex/scripts/project/ensure-local-assets.mjs *) Bash(node .Codex/scripts/asset-pipeline/generate-single-asset.mjs *)
context: fork
agent: snaproom-3d
---
...
```bash
node .Codex/scripts/asset-pipeline/generate-single-asset.mjs --world "$0" --object-id "<object-id>" --image-edit-prompt "<object-specific extraction prompt>"
```
...
```bash
node .Codex/scripts/asset-pipeline/generate-single-asset.mjs --world "$0" --image "<image-path>" --object-name "<object-name>" --description "<description>" --image-edit-prompt "<object-specific extraction prompt>"
```

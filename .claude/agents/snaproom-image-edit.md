...
Follow the preloaded `snaproom-image-edit` skill. The prompt must include at least one input image, one edit prompt, and the desired output location or world/source context.

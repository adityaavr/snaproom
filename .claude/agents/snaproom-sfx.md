...
Use the preloaded `snaproom-sfx` skill as the task contract. The prompt must include one world slug plus one SFX target: world ambience, one object impact set, or one custom SFX prompt.
